"""
Django settings for SocialAuthPro project.
...
ROOT_URLCONF = 'SocialAuthPro.urls'
...
WSGI_APPLICATION = 'SocialAuthPro.wsgi.application'
...
SOCIAL_AUTH_PIPELINE = [
    ...
    # create profile using social auth
